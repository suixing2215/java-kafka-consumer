...
public class DataSourceUtil implements Serializable {
    ...
    static {
        try {
            ...
            props.setProperty("driverClassName",ConfigurationManager.getProperty("db.driver"));
            props.setProperty("url", ConfigurationManager.getProperty("db.url"));
            props.setProperty("username", ConfigurationManager.getProperty("db.user"));
            props.setProperty("password", ConfigurationManager.getProperty("db.password"));
            ...
            props.setProperty("validationQuery", "select 1");//验证数据库连接
